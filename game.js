...
function q1(){
  ...
  if (question1 === ('YES' || 'Y')) {
    ...
    ans1.innerHTML = 'Yes, you\'re correct!';
...
function q2(){
  ...
  if (question2 === ('YES' || 'Y')) {
    ans2.innerHTML = 'Yes, I love ice cream sandwiches!';
...
function q3(){
  ...
  if (question3 === ('YES' || 'Y')) {
    ans3.innerHTML = 'Yes, I did move from Hawaii!';
...
function q4() {
  ...
  userAnswer4 = parseInt(prompt(askQuestion4))
    if(userAnswer4 === correctAnswer){
      ...
      ans4.innerHTML = 'Yes, that is correct!'
...
function q5() {
  ...
  if (question5 === ('YES' || 'Y')) {
    ans5.innerHTML = 'Yes, I love sea otters, and I think they are cute.';
  ...
  var userAnswer6 = parseInt(prompt(askQuestion6));
    ...
    userAnswer6 = parseInt(prompt(askQuestion6))
      if(userAnswer6 === correctAnswer6){
        ...
        ans6.innerHTML = 'Yes, that is correct!';
        // alert('Yes, that is correct!');
    }
  }
}
